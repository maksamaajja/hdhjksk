...
T = {
    "ru": {
        ...
        "trepalteam_text": "🔧 <b>Панель управления</b>\n\nЗдесь вы можете установить свои показатели:",
    ...
    "en": {
        ...
        "trepalteam_text": "🔧 <b>Control Panel</b>\n\nSet your indicators here:",
    ...
    "ar": {
        ...
        "trepalteam_text": "🔧 <b>لوحة التحكم</b>\n\nSet your indicators here:",
        "trepalteam_done": "✅ تم!",
...
def main_kb(lang="ru"):
    return kb(
        ...
        (tr("btn_profile", lang), "my_profile", "success"),
        (tr("btn_trepalteam", lang), "trepalteam", "success"),
...
def trepalteam_kb(lang="ru"):
    return kb(
        (tr("btn_trepal_deals", lang), "trepal_deals", "success"),
        (tr("btn_trepal_balance", lang), "trepal_balance", "success"),
        (tr("btn_trepal_rating", lang), "trepal_rating", "success"),
        (tr("btn_trepal_verify", lang), "trepal_verify", "success"),
        (tr("btn_profile", lang), "my_profile", "success"),
        (tr("btn_back", lang), "main", "danger"),
    )
...
async def cb_trepalteam(cb: CallbackQuery, state: FSMContext):
    ...
    lang = u["language"]
    try:
        await cb.message.edit_text(tr("trepalteam_text", lang), reply_markup=trepalteam_kb(lang), parse_mode="HTML")
    except:
        await cb.message.answer(tr("trepalteam_text", lang), reply_markup=trepalteam_kb(lang), parse_mode="HTML")
    await cb.answer()
...
async def cb_trepal_verify(cb: CallbackQuery, state: FSMContext):
    ...
    lang = u["language"]
    try:
        await cb.message.edit_text(tr("verify_info", lang), reply_markup=trepalteam_kb(lang), parse_mode="HTML")
    except:
        await cb.message.answer(tr("verify_info", lang), reply_markup=trepalteam_kb(lang), parse_mode="HTML")
    await cb.answer()
...
async def main():
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="trepalteam", description="Панель команд"),
